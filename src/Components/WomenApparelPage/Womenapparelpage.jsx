...
import Shoes1 from '../Assets/Womenpage/Womenapparel1.jpg'
import Shoes2 from '../Assets/Womenpage/Womenapparel2.jpg'
...
function Womenapparelpage() {
      ...
      return (
          ...
          <div>
                <Helmet>
                    <title>Buy Women Appatrel Collection Online In Pakistan|Ndure - Ndure.com </title>
                </Helmet>
                <Womenheader />
                
        <h1 className='menpagehead text-start mx-5'>WOMEN APPAREL</h1>
...
export default Womenapparelpage
