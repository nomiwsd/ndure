  ...
  return (
    <div>
          ...
          <Offcanvas show={show2} onHide={handleClose2} responsive="lg">
            ...
            <Offcanvas.Body>
              ...
              <div className="row justify-content-center d-block px-3 py-3 ">
                <div className="col-1 ps-0 py-2"> <a href='#'>Summer'22</a> </div>
                ...
                <hr className='w-100 m-0 py-0' />
                <div className="col-1 ps-0 py-2"><a href='#'>Accessories</a></div>
                <hr className='w-100 m-0 py-0' />
                <div className="col-1 ps-0 py-2"><a href='#'>Sale</a></div>
              </div>
          ...
          <Offcanvas show={show} onHide={handleClose} placement="end" responsive="">
            ...
            <Offcanvas.Body>
              <Form className='mx-3'>
                ...
                <Button className='offcanvasbtn w-100' >
                  Login
                </Button>
      ...
      <div className="row justify-content-center d-none d-md-flex d-lg-flex secnavbar py-3 m-0">
        ...
        <div className="col-1 navitem ps-0"><a href='#'>Accessories</a></div>
        <div className="col-1 navitem ps-0"><a href='#'>Sale</a></div>
      </div>
    </div>
  )
}
