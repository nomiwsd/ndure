...
import Apparel1 from '../Assets/Menpage/Apparel.jpg'
import Apparel2 from '../Assets/Menpage/MenApparel2.jpg'
...
import '../Menshoespage/Menshoes.css'
function MenApparel() {
  ...
  return (
    <div>
    <Helmet>
        <title>Buy Men Apparel Collection Online In Pakistan|Ndure - Ndure.com </title>
    </Helmet>
    <Menheader />
    
    <h1 className='menpagehead text-start mx-5'>APPAREL MEN</h1>
        ...
        <div className="row py-3 m-0  justify-content-between ">
            <div className="col-lg-3 col-6 m-0 p-0" >
                <div className="card my-3 mx-1">
                    <div class="thumbnail">
                        <div class="picture1">
                            <img src={Apparel1} className="col-12" alt="" />
                        </div>
                        <div class="picture2">
                            <img src={Apparel2} className="col-7" alt="" />
                        </div>
                    </div>
                    <div class="card-body">
                        <p class="card-text shoespagetxt">Men's Basic V Half Sleeves T-Shirt <br />
                            <del>RS.1,000.00</del> <span className='text-danger'>RS.500.00</span> </p>
                    </div>
                </div>
            </div>
