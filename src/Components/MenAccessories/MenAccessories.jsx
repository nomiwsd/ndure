...
import Accesories1 from '../Assets/Menpage/MenAccessories1.jpg'
import Accesories2 from '../Assets/Menpage/MenAccessories.jpg'
...
function MenAccessories() {
  ...
  return (
    ...
    <h1 className='menpagehead text-start mx-5'>MEN'S ACCESSORIES</h1>
        ...
        <div className="row py-3 m-0 ">
            <div className="col-lg-3 col-6 m-0 p-0" >
                <div className="card my-3 mx-1">
                    <div class="thumbnail">
                        <div class="picture1">
                            <img src={Accesories1} className="col-12" alt="" />
                        </div>
                        <div class="picture2">
                            <img src={Accesories2} className="col-12" alt="" />
                        </div>
                    </div>
                    <div class="card-body">
                        <p class="card-text shoespagetxt">Shoe Care Kit-Brown <br />
                            <del>RS.1,199.00</del> <span className='text-danger'>RS.840.00</span> </p>
                    </div>
                </div>
            </div>
            <div className='col-lg-3 col-6 p-0 m-0'>
                <div className="card my-3 mx-1">
                    ...
                    <div class="card-body">
                        <p class="card-text shoespagetxt">Shoe Care Kit-Black <br />
                            <del>RS.1,199.00</del> <span className='text-danger'>RS.840.00</span> </p>
                    </div>
                </div></div>
