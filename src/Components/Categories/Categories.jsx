...
function Categories() {
  return (
    <div>
        ...
        {/* Men Section */}
      <div className="row  align-items-center Mainsect m-0 ">
        <div className="col-lg-3 col-md-3 col-12 p-0 mb-3">
        ...
        <div className=" justify-content-start overfs m-0 gap-3  d-flex flex-row p-0">
              <div className="col-8 col-md-5 col-lg-4 cimg"> 
      ...
      {/* Women Section */}
      <div className="row  align-items-center Mainsect m-0 ">
        <div className="col-lg-3 col-12 p-0 mb-3">
        ...
        <div className="col-lg-9 col-md-9">
        <div className=" justify-content-start overfs mx-3 gap-3 d-flex flex-row p-0">
              <div className="col-8  col-md-5 col-lg-4 cimg"> 
        ...
        <div className=" justify-content-start overfs mx-3 gap-3 d-flex flex-row p-0">
              ...
              <div className="overlay"></div>
               ...
               <div className="col-8 col-md-5 col-lg-4 cimg ">
                <img src={Sale2}  alt=""  className="col-12 col-md-12p-0" />
                <div className="overlay"></div>
